CREATE OR REPLACE PROCEDURE CON.SP_CON_DIM_DOC_CLASEORDFAB()
...
BEGIN
    ...
    BEGIN
        ...
        DELETE FROM CON.DIM_DOC_CLASEORDFAB;
    ...
    BEGIN
        ...
        INSERT INTO CON.DIM_DOC_CLASEORDFAB
        (
            CLASEORDFAB_ID,
            CLASEORDFAB_TEXT,
            SISORIGEN_ID,
        ...
        SELECT
            ...
            FECHA_CARGA,
            ZONA_HORARIA
        FROM PRE.PDIM_DOC_CLASEORDFAB;

        -- Conteo de filas insertadas
        SELECT COUNT(*) INTO :ROWS_INSERTED FROM CON.DIM_DOC_CLASEORDFAB;
    ...
    VALUES ('SP_CON_DIM_DOC_CLASEORDFAB','DIM_DOC_CLASEORDFAB', :F_INICIO, :F_FIN, :T_EJECUCION, :ROWS_INSERTED, :TEXTO );
