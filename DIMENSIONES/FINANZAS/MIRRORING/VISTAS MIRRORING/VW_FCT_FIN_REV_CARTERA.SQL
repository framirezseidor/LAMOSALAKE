CREATE OR REPLACE VIEW MIRRORING.VW_FCT_FIN_REV_CARTERA(
	ANIO,
    MES,
    ANIO_MES,
    SOCIEDAD_ID,
...
CREATE OR REPLACE STREAM MIRRORING.STREAM_VW_FCT_FIN_REV_CARTERA
ON VIEW MIRRORING.VW_FCT_FIN_REV_CARTERA;