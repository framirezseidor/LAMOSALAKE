CREATE OR REPLACE VIEW MIRRORING.VW_FCT_FIN_ADH_CARTERA(
	ANIO,
    MES,
    ANIO_MES,
    SOCIEDAD_ID,
...
CREATE OR REPLACE STREAM MIRRORING.STREAM_VW_FCT_FIN_ADH_CARTERA
ON VIEW MIRRORING.VW_FCT_FIN_ADH_CARTERA;