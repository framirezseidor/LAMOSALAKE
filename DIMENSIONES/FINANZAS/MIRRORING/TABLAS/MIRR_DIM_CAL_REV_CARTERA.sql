CREATE OR REPLACE TABLE MIRRORING.DIM_CAL_REV_CARTERA AS
WITH CTE_FECHAS AS (
...
CREATE OR REPLACE STREAM MIRRORING.STREAM_DIM_CAL_REV_CARTERA
ON TABLE MIRRORING.DIM_CAL_REV_CARTERA;