CREATE OR REPLACE TABLE MIRRORING.DIM_CAL_GASTOSCONTROLPRES AS
WITH CTE_FECHAS AS (
...
SELECT
  ...
  TO_VARCHAR(FECHA, 'YYYYMM') AS ANIOMES,
...
CREATE OR REPLACE STREAM MIRRORING.STREAM_DIM_CAL_GASTOSCONTROLPRES
ON TABLE MIRRORING.DIM_CAL_GASTOSCONTROLPRES;