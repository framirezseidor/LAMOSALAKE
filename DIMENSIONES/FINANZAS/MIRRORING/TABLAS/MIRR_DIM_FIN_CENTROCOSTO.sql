CREATE OR REPLACE TABLE MIRRORING.DIM_FIN_CENTROCOSTO(
    CENTROCOSTO_ID VARCHAR(15),
	CENTROCOSTO VARCHAR(10),
	CENTROCOSTO_TEXT VARCHAR(40),
    CENTROCOSTO_ID_TEXT VARCHAR(60),
...
CREATE OR REPLACE STREAM MIRRORING.STREAM_DIM_FIN_CENTROCOSTO
ON TABLE MIRRORING.DIM_FIN_CENTROCOSTO;