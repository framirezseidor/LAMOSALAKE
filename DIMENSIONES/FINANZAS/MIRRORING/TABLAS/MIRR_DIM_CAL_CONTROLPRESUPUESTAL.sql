CREATE OR REPLACE TABLE MIRRORING.DIM_CAL_CONTROLPRESUPUESTAL AS
WITH CTE_FECHAS AS (
...
CREATE OR REPLACE STREAM MIRRORING.STREAM_DIM_CAL_CONTROLPRESUPUESTAL
ON TABLE MIRRORING.DIM_CAL_CONTROLPRESUPUESTAL;