CREATE OR REPLACE TASK MIRRORING.TASK_FCT_FIN_ADH_CARTERA
	...
	WHEN SYSTEM$STREAM_HAS_DATA('STREAM_VW_FCT_FIN_ADH_CARTERA')
	AS BEGIN

    -- 1. TRUNCAR tabla temporal
    TRUNCATE TABLE MIRRORING.TR_FCT_FIN_ADH_CARTERA;

    -- 2. INSERTAR datos desde el stream a la temporal
    INSERT INTO MIRRORING.TR_FCT_FIN_ADH_CARTERA
    SELECT * FROM MIRRORING.STREAM_VW_FCT_FIN_ADH_CARTERA;
