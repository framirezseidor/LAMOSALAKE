...
SELECT COUNT(*) AS total_registros_raw
FROM RAW.SQ1_EXT_  UNION ALL

SELECT COUNT(*) AS total_registros_raw
FROM RAW.SQ1_EXT_;

--Confirmar la ejecución de las Stored Procedures (SPs) para transformar los datos de RAW a PRE y de PRE a CON.
SELECT * FROM LOGS.HISTORIAL_EJECUCIONES WHERE TABLA_DESTINO IN ('PRE.PDIM_MAT_','CON.DIM_MAT_') ;

SELECT COUNT(*) FROM PRE.PDIM_MAT_;
SELECT COUNT(*) FROM CON.DIM_MAT_;
...
SELECT COUNT(*) FROM PRE.PDIM_MAT_ UNION ALL
SELECT COUNT(*) FROM CON.DIM_MAT_;
...
SELECT * FROM CON.VW_DIM_MAT_;
SELECT * FROM CON.VW_DIM_MAT_;

SELECT COUNT(*) FROM CON.VW_DIM_MAT_;
SELECT COUNT(*) FROM CON.VW_DIM_MAT_;
...
WHERE TABLE_NAME = 'PDIM_MAT_' AND TABLE_SCHEMA = 'PRE';

SELECT COLUMN_NAME, DATA_TYPE
FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'DIM_MAT_' AND TABLE_SCHEMA = 'CON';
...
SELECT * FROM PRE.PDIM_MAT_;
SELECT * FROM CON.DIM_MAT_;
...
SELECT COUNT(*) FROM RAW.SQ1_EXT_;
SELECT COUNT(*) FROM RAW.SQ1_EXT_;
SELECT COUNT(*) FROM PRE.PDIM_MAT_;
SELECT COUNT(*) FROM CON.DIM_MAT_;
