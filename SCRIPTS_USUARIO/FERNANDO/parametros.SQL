...
VALUES
    ...
    (6, 'ZBWSD_PEDIDOS_BACKORDER', 'PRUEBAINTEGRAL', 'ERDAT', '20250701', '20250830'),
...
select distinct(extractor), * from raw.parametros_extraccion;
...
ORDER BY FECHA_HORA_INICIO DESC limit 10  ;
