...
SELECT DISTINCT VKORG FROM LAMOSALAKE_DEV.RAW.SQ1_MOF_ZBWSD_PEDIDOS_BACKORDER
ORDER BY VKORG; -- 4 valores: R101, R311, R401, R501
select * from lamosalake_dev.raw.parametros_extraccion;


SELECT * FROM LAMOSALAKE_DEV.RAW.SQ1_MOF_ZBWSD_PEDIDOS_BACKORDER;
SELECT * FROM LAMOSALAKE_DEV.PRE.PFCT_COM_BACKORDER;

SELECT * FROM LAMOSALAKE_DEV.CON.FCT_COM_REV_BACKORDER_ACT;
SELECT * FROM LAMOSALAKE_DEV.CON.FCT_COM_ADH_BACKORDER_ACT;
