CREATE OR REPLACE PROCEDURE CON.SP_CON_FCT_COM_ADH_VENTAS_ACT(
...
BEGIN
    ...
    BEGIN
        ...
        DELETE FROM CON.FCT_COM_ADH_VENTAS_ACT
        WHERE
    ...
    BEGIN
        ...
        MERGE INTO CON.FCT_COM_ADH_VENTAS_ACT A
        USING  (SELECT
                    ANIO,
                    MES, 
                    ANIOMES, 
                    ...
                    GRUPOARTICULOS_ID, 
                    TIPOMATERIAL_ID, 
                    IND_VENTA_REAL_EST AS IND_VENTA_REAL_TON, 
                    UNI_EST, 
                    IND_VENTA_REAL_UMV, 
                    UNI_UMV, 
                ...
                FROM 
                    PRE.PFCT_COM_VENTAS
                WHERE
                    TIPOMATERIAL_ID IN ('ZHAW','FERT')
                    AND SOCIEDAD_ID BETWEEN :SOCIEDAD_INICIO AND :SOCIEDAD_FIN ) P
        ...
        UPDATE SET 
            ...
            A.UENADHESIVOS_ID  = P.UENADHESIVOS_ID ,
            A.PAIS_ID  = P.PAIS_ID ,
            A.REGION_ID  = P.REGION_ID ,
            A.ZONATRANSPORTE_ID  = P.ZONATRANSPORTE_ID ,
            A.GRUPO_TRANSACCION = P.GRUPO_TRANSACCION,
            ...
            A.IND_VENTA_REAL_TON  = P.IND_VENTA_REAL_TON ,
            A.UNI_EST  = P.UNI_EST ,
    ...
    VALUES ('SP_CON_FCT_COM_ADH_VENTAS_ACT','FCT_COM_ADH_VENTAS', :F_INICIO, :F_FIN, :T_EJECUCION, :ROWS_INSERTED, :TEXTO );
