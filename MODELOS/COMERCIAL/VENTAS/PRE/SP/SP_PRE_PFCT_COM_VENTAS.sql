...
BEGIN
    ...
    BEGIN
        ...
        SELECT   
            ...
            FKTYP AS GRUPO_TRANSACCION,  
            VBTYP AS TIPO_TRANSACCION ,
            LTRIM(VBELN_VF,'0') AS FACTURA ,
            ...
            COALESCE(U_UMV.VALOR_ESTANDARD, T.VRKME) AS UNI_UMV,
        ...
        FROM 
            ...
            LEFT JOIN RAW.CAT_UNIDAD_ESTADISTICA U_UMV
                ON UPPER(TRIM(T.VRKME)) = UPPER(TRIM(U_UMV.VALOR_ORIGINAL))
