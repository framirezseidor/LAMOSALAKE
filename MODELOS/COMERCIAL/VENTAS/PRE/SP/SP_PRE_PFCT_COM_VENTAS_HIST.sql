    ...
    BEGIN
        ...
        BEGIN
            ...
            SELECT
                ...
                LEFT("[ZCSEGMENT].[2ZCSEGMENT] Clave", 2) AS SEGMENTO_CLAVE, 
                "[ZCUEN] O.UEN", 
                "[ZCUEN].[2ZCUEN] Clave", 
...
SELECT distinct "[0CALMONTH].[20CALMONTH] Clave"
FROM RAW.BW4_VENTAS_HIST_150725 V
WHERE RIGHT("[0CALMONTH].[20CALMONTH] Clave", 4) IN ('2024', '2025');
