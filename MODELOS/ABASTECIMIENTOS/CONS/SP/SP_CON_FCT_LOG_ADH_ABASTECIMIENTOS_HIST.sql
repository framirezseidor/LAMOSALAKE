CREATE OR REPLACE PROCEDURE CON.SP_CON_FCT_LOG_ADH_ABASTECIMIENTOS_HIST()
...
---------------------------------------------------------------------------------
 ...
 Descripción:        SP FULL que transforma datos desde la capa PRE a CON para ABASTECIMIENTOS ADH HISTORICO
---------------------------------------------------------------------------------
*/
...
BEGIN
    ...
    BEGIN
        ...
        DELETE FROM CON.FCT_LOG_ADH_ABASTECIMIENTOS_HIST
        ;
    ...
    BEGIN
        ...
        INSERT INTO CON.FCT_LOG_ADH_ABASTECIMIENTOS_HIST(
        CENTRO_ID,
        ALMACENCENTRO_ID,
        ORGCOMPRAS_ID,
        GRUPOCOMPRAS_ID,
        ...
        FROM PRE.PFCT_LOG_ABASTECIMIENTOS_HIST
...
;
        ...
        SELECT COUNT(*) INTO :ROWS_INSERTED FROM CON.FCT_LOG_ADH_ABASTECIMIENTOS_HIST;
    ...
    --CONDICION EXPEDICION
        CREATE OR REPLACE TABLE MIRRORING.FCT_LOG_ADH_ABASTECIMIENTOS
    ...
    VALUES ('SP_CON_FCT_LOG_ADH_ABASTECIMIENTOS_HIST','CON.FCT_LOG_ADH_ABASTECIMIENTOS_HIST', :F_INICIO, :F_FIN, :T_EJECUCION, :ROWS_INSERTED, :TEXTO );
