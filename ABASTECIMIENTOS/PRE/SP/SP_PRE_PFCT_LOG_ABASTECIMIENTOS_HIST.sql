CREATE OR REPLACE PROCEDURE PRE.SP_PRE_PFCT_LOG_ABASTECIMIENTOS_HIST()
...
---------------------------------------------------------------------------------
 ...
 Descripción:        SP FULL que transforma datos desde la capa RAW a PRE para ABASTECIMIENTOS HISTORICO
---------------------------------------------------------------------------------
*/
...
BEGIN
    ...
    BEGIN
        ...
        SELECT R_FIN --R_INICIO para CARGAS FACT y RFIN para HISTORICOS
        INTO :SISORIGEN 
    ...
    BEGIN
        ...
        LEFT JOIN (----------agrupacion de fletes---------
            ...
            FROM RAW.SQ1_MOF_ZMM_IND_ADQUISICION_HIST
            GROUP BY ALL
...
;
        ...
        SELECT COUNT(*) INTO :ROWS_INSERTED FROM PRE.PFCT_LOG_ABASTECIMIENTOS_HIST;
    ...
    VALUES ('SP_PRE_PFCT_LOG_ABASTECIMIENTOS_HIST','PRE.PFCT_LOG_ABASTECIMIENTOS_HIST', :F_INICIO, :F_FIN, :T_EJECUCION, :ROWS_INSERTED, :TEXTO );
