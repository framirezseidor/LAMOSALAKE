CREATE OR REPLACE PROCEDURE PRE.SP_PRE_PFCT_LOG_ABASTECIMIENTOS()
...
---------------------------------------------------------------------------------
 ...
 Descripción:        SP FULL que transforma datos desde la capa RAW a PRE para ABASTECIMIENTOS
---------------------------------------------------------------------------------
*/
...
BEGIN
    ...
    BEGIN
        ...
        WHERE CONCAT(SUBSTR(FECHA_DOCCOMPRAS, 0, 4), SUBSTR(FECHA_DOCCOMPRAS, 6, 2)) BETWEEN :FECHA_INICIO AND :FECHA_FIN
...
;
    ...
    VALUES ('SP_PRE_PFCT_LOG_ABASTECIMIENTOS','PRE.PFCT_LOG_ABASTECIMIENTOS', :F_INICIO, :F_FIN, :T_EJECUCION, :ROWS_INSERTED, :TEXTO );
