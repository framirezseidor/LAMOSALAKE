CREATE OR REPLACE PROCEDURE CON.SP_CON_FCT_LOG_REV_ABASTECIMIENTOS_HIST()
...
---------------------------------------------------------------------------------
 ...
 Descripción:        SP FULL que transforma datos desde la capa PRE a CON para ABASTECIMIENTOS REV HISTORICO
---------------------------------------------------------------------------------
*/
...
BEGIN
    ...
    BEGIN
        ...
        DELETE FROM CON.FCT_LOG_REV_ABASTECIMIENTOS_HIST
        ;
    ...
    BEGIN
        ...
        INSERT INTO CON.FCT_LOG_REV_ABASTECIMIENTOS_HIST(
        CENTRO_ID,
        ALMACENCENTRO_ID,
        ORGCOMPRAS_ID,
        GRUPOCOMPRAS_ID,
...
;
        ...
        SELECT COUNT(*) INTO :ROWS_INSERTED FROM CON.FCT_LOG_REV_ABASTECIMIENTOS_HIST;
