...
---------------------------------------------------------------------------------
 ...
 Descripción:        SP DELTA que transforma datos desde la capa PRE a CON para ABASTECIMIENTOS ADH
---------------------------------------------------------------------------------
*/
...
;
        ...
        SELECT COUNT(*) INTO :ROWS_INSERTED FROM CON.FCT_LOG_ADH_ABASTECIMIENTOS;
    ...
    VALUES ('SP_CON_FCT_LOG_ADH_ABASTECIMIENTOS_DELTA','CON.FCT_LOG_ADH_ABASTECIMIENTOS', :F_INICIO, :F_FIN, :T_EJECUCION, :ROWS_INSERTED, :TEXTO );
