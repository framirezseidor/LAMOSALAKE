...
CREATE OR REPLACE PROCEDURE CON.SP_CON_FACT_FIN_GASTOSREAL("FECHA_INICIO" VARCHAR(100), "FECHA_FIN" VARCHAR(100))
...
---------------------------------------------------------------------------------
 ...
 Descripción:        SP que transforma datos desde la capa PRE a CON para la tabla FCT_FIN_GASTOSREAL
---------------------------------------------------------------------------------
*/
...
BEGIN
	...
	BEGIN
        ...
        SELECT COUNT(*) INTO :ROWS_INSERTED FROM CON.FCT_FIN_GASTOSREAL;
    ...
    VALUES ('CON.SP_CON_FACT_FIN_GASTOSREAL','CON.FCT_FIN_GASTOSREAL', :F_INICIO, :F_FIN, :T_EJECUCION, :ROWS_INSERTED, :TEXTO );
