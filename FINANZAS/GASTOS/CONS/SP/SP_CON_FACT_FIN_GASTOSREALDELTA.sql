CREATE OR REPLACE PROCEDURE CALL CON.SP_CON_FACT_FIN_GASTOSREALDELTA()
...
---------------------------------------------------------------------------------
 ...
 Descripción:        SP delta que transforma datos desde la capa PRE a CON para la tabla FCT_FIN_GASTOSREAL
---------------------------------------------------------------------------------
*/
...
BEGIN
    ...
    BEGIN
        ...
        DELETE FROM CON.FCT_FIN_GASTOSREAL WHERE ANIOMES IN (SELECT ANIOMES FROM RAW.SQ1_EXT_0CO_OM_CCA_9_ANIOMESDELTA);
    ...
    INSERT INTO CON.FCT_FIN_GASTOSREAL (
                TIPO,
                ANIO,
                MES,
                ANIOMES,
    ...
    WHERE ANIOMES IN (SELECT ANIOMES FROM RAW.SQ1_EXT_0CO_OM_CCA_9_ANIOMESDELTA);
    ...
    VALUES ('CON.SP_CON_FACT_FIN_GASTOSREALDELTA','CON.FCT_FIN_GASTOSREAL', :F_INICIO, :F_FIN, :T_EJECUCION, :ROWS_INSERTED, :TEXTO );
