CREATE OR REPLACE PROCEDURE CALL PRE.SP_PRE_FACT_FIN_GASTOSREAL('2025001','2025012')("FECHA_INICIO" VARCHAR(100), "FECHA_FIN" VARCHAR(100))
...
BEGIN
	...
	BEGIN
        ...
        SELECT
            ...
            CONCAT(KOKRS,'_',CCA_9.KOSTL) AS "CENTROCOSTO_ID",
            CCA_9.KOSTL AS "CENTROCOSTO",
