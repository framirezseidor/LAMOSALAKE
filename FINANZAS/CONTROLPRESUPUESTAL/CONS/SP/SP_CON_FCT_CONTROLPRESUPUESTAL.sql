...
CREATE OR REPLACE PROCEDURE CON.SP_CON_FCT_CONTROLPRESUPUESTAL("FECHA_INICIO" VARCHAR(100), "FECHA_FIN" VARCHAR(100))
        ...
        // Process INSERT
			INSERT INTO CON.FCT_FIN_CONTROLPRESUPUESTAL (
                ...
                ZONA_HORARIA )
					...
					AND ANIOMES BETWEEN :FECHA_INICIO AND :FECHA_FIN
			;
