CREATE OR REPLACE PROCEDURE PRE.SP_PRE_FCT_CARTERAACT("ANIOMES" VARCHAR(100))
...
---------------------------------------------------------------------------------
 ...
 Descripción:        SP que transforma datos desde la capa RAW a PRE para la tabla PFCT_FIN_CARTERAACT
---------------------------------------------------------------------------------
*/
...
BEGIN
    ...
    BEGIN
        ...
        // Process DELETE
        DELETE FROM PRE.PFCT_FIN_CARTERAACT;
	...
	BEGIN
        ...
        // Proceso INSERT
	INSERT INTO PRE.PFCT_FIN_CARTERAACT
	SELECT  SUBSTR(FACT.VALID_FROM,1,4) AS ANIO,
        ...
        SELECT COUNT(*) INTO :ROWS_INSERTED FROM PRE.PFCT_FIN_CARTERAACT;
    ...
    VALUES ('PRE.SP_PRE_FACT_CARTERAACT','PRE.PFCT_FIN_CARTERAACT', :F_INICIO, :F_FIN, :T_EJECUCION, :ROWS_INSERTED, :TEXTO );
