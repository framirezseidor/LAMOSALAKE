CREATE OR REPLACE PROCEDURE CON.SP_CON_FCT_ADH_BACKORDER_FOTO(
...
---------------------------------------------------------------------------------
 ...
 Descripción:        SP que transforma datos desde la capa PRE A CON para FCT_COM_ADH_BACKORDER_FOTO
---------------------------------------------------------------------------------
*/
...
BEGIN
    ...
    BEGIN
        ...
        DELETE FROM CON.FCT_COM_ADH_BACKORDER_FOTO
        WHERE 
    ...
    BEGIN
        ...
        INSERT INTO CON.FCT_COM_ADH_BACKORDER_FOTO (
            FECHA_BACKORDER,
            ANIO,
            MES,
            ANIOMES,
        ...
        SELECT COUNT(*) INTO :ROWS_INSERTED FROM CON.FCT_COM_ADH_BACKORDER_FOTO
        WHERE ORGVENTAS_ID LIKE 'A%'
            AND SOCIEDAD_ID BETWEEN :SOCIEDAD_INICIO AND :SOCIEDAD_FIN  
            AND CANALDISTRIB_ID BETWEEN :CANAL_INICIO AND :CANAL_FIN
            AND UNI_EST BETWEEN 
    ...
    ---------------------------------------------------------------------------------
        ...
        VALUES('SP_CON_FCT_ADH_BACKORDER_FOTO','FCT_COM_ADH_BACKORDER_FOTO', :F_INICIO, :F_FIN,:T_EJECUCION ,:ROWS_INSERTED, :TEXTO );
    ...
    TRUNCATE TABLE CON.FCT_COM_ADH_BACKORDER_ACT; --TRUNCAR ACTUAL PARA QUE NO HAYA DUPLICADOS
