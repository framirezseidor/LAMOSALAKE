...
---------------------------------------------------------------------------------
 ...
 Descripción:        SP que transforma datos desde la capa PRE a CON para FCT_COM_ADH_VENTAS_ACT
---------------------------------------------------------------------------------
*/
...
BEGIN
    ...
    BEGIN
        ...
        DELETE FROM LAMOSALAKE_DEV.CON.FCT_COM_ADH_VENTAS_ACT;
    ...
    BEGIN
        ...
        INSERT INTO LAMOSALAKE_DEV.CON.FCT_COM_ADH_VENTAS_ACT
        (
            ANIO,
            MES,
            ANIOMES,
        ...
        WHERE UPPER(ORGVENTAS_ID) IN ('A101', 'A102', 'A103', 'A104');

        -- Conteo de filas insertadas
        SELECT COUNT(*) INTO :ROWS_INSERTED FROM LAMOSALAKE_DEV.CON.FCT_COM_ADH_VENTAS_ACT;
