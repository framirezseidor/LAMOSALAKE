...
BEGIN
    ...
    PARAMETRO := 'FKDAT';
    SELECT RAW.FN_BUSCA_PARAMETRO( :EXTRACTOR , :NEGOCIO , :PARAMETRO) INTO :TEXTO ;

    F_INICIO := SPLIT_PART(TEXTO,'-',2);
    F_FIN := SPLIT_PART(TEXTO,'-',1);        
    ...
    BEGIN
        ...
        USING (SELECT ANIO,
                        ...
                        ZONA_HORARIA
            FROM PRE.PFCT_COM_VENTAS WHERE SOCIEDAD_ID BETWEEN :SOCIEDAD_INICIO AND :SOCIEDAD_FIN) P
